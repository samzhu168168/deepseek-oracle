...
const STATIC_URLS = [
  ...
  { loc: "/relationship-patterns/why-do-i-keep-attracting-the-same-type-of-partner", priority: "0.9" },
  { loc: "/relationship-patterns/why-do-i-always-care-more", priority: "0.9" },
  { loc: "/relationship-patterns/why-does-he-pull-away-when-we-get-close", priority: "0.9" },
